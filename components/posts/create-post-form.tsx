...
export const CreatePostForm: FC = () => {
  ...
  const form = useForm<z.infer<typeof CreatePostValidator>>({
  ...
  async function onSubmit(values: z.infer<typeof CreatePostValidator>) {
    const res = await axios.post("/api/posts/create", values);
